...
if(!empty($_POST)) {
    require_once ('../admin/db/dbhelper.php');
	  ...
	  $namebrigdes = $_POST['name_brigdes'];
	...
	$sql = "insert into brigdes (id, city_id, name_brigdes, thumbnail) values ('','','$namebrigdes', '$thumbnail');
          insert into city (id, countrt_id, name_city, address) values ('','','$city', '$address');
          insert into country (id, name_country, continents_id) values ('','$country','');
          insert into continents (id, name_continents) values ('', '$continent');";
	query($sql);
}
?>
<!DOCTYPE html>
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/feedbacklist.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
